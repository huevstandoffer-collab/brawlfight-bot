...
# Канал для обязательной подписки (бот должен быть админом канала)
CHANNEL_USERNAME = os.getenv("CHANNEL_USERNAME", "BrawlFightBotNews")
CHANNEL_LINK = os.getenv("CHANNEL_LINK", "https://t.me/BrawlFightBotNews")
# Можно отключить проверку: REQUIRE_SUB=0
REQUIRE_SUB = os.getenv("REQUIRE_SUB", "1") not in ("0", "false", "False", "no")
